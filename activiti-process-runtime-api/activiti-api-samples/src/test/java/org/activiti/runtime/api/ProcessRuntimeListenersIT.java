...
public class ProcessRuntimeListenersIT {
    ...
    @Autowired
    private DummyTaskCreatedRuntimeEventListener taskCreatedRuntimeEventListener;

    @Before
    public void setUp() {
        processStartedEventListener.clear();
        taskCreatedRuntimeEventListener.clear();
    }
    ...
    public void taskCreatedShouldTriggerCreateTaskListeners() {
        ...
        //then
        assertThat(taskCreatedRuntimeEventListener.getTasks()).containsEntry(processInstance.getId(), "Perform action");
    }
